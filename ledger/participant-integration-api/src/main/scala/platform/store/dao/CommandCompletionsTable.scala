...
private[platform] object CommandCompletionsTable {
  ...
  case class CompletionStreamResponseWithParties(completion: CompletionStreamResponse, parties: Set[Ref.Party])
  ...
  def prepareGetForAllParties(
    ...
    SQL"""select completion_offset, record_time, command_id, transaction_id, status_code, status_message, submitters
